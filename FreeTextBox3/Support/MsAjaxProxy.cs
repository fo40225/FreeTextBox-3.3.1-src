...
namespace FreeTextBoxControls.Support
{
    ...
    public class MsAjaxProxy
    {
        ...
        public static bool IsMsAjax()
        {
            ...
            System.Web.HttpContext.Current.Response.Write("assembly: " + (ScriptAssembly != null).ToString());
             * */
            //System.Web.HttpContext.Current.Response.Write(", manager: " + (scriptManagerType != null).ToString());
