        ...
        internal Decoder SniffMeta(){
            ...
            while (i != EOF){
                ...
                if (ch == '<') {
                    ...
                    if (name != null && name.ToLower() == "meta"){
                        ...
                        if (httpequiv != null && httpequiv.ToLower() == "content-type" && content != null){
...
/// <exclude />
    public class SgmlDtd
    {
        ...
        void ParseElementDecl()
        {
            ...
            bool sto = (Char.ToLower(this.current.SkipWhitespace()) == 'o'); // start tag optional?   
            this.current.ReadChar();
            bool eto = (Char.ToLower(this.current.SkipWhitespace()) == 'o'); // end tag optional? 
            this.current.ReadChar();
            ch = this.current.SkipWhitespace();
